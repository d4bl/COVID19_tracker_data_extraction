...
def get_esri_feature_data(data_url, fields=None, index=None,
                          force_remote=False):
    """For states using ESRI web services, the feature data includes a list of fields and their values.
    ...
    * finally returns a DataFrame of the features' attribute objects.
    ...
    if fields:
        ...
        if extra_fields:
            raise ValueError(f'Requested fields not present in API response: {extra_fields}')
