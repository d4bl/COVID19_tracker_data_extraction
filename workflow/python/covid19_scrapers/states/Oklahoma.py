...
class Oklahoma(ScraperBase):
    ...
    """
    CASES_DASHBOARD_URL = 'https://looker-dashboards.ok.gov/embed/dashboards/75'
    DEATH_DASHBOARD_URL = 'https://looker-dashboards.ok.gov/embed/dashboards/76'
    ...
    def _scrape(self, **kwargs):
        ...
        aa_cases = percentages_black_cases*(total_cases/100)
        aa_deaths = percentage_black_deaths*(total_deaths/100)
